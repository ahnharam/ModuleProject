...
{
    public class MultikhanAutoBroadcastInfoNewDBModel : IsEditUpdater, IDBQuery
    {
        // 원본 데이터 필드
        private int _no;
        ...
        {
            // 현재는 서브 쿼리가 필요하지 않으므로 빈 배열을 반환합니다.
            return new string[] { };
        }
    ...
    public class MultikhanAutoBroadcastInfoNewDBList : BaseDBListByOC<MultikhanAutoBroadcastInfoNewDBModel>
    {
