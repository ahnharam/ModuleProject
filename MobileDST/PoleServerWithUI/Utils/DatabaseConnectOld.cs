...
{
    internal class DatabaseConnectOld
    {
        ...
        // Property
        private static DatabaseConnectOld _instance { get; set; }

        public static DatabaseConnectOld Instance
        {
            get
            {
                return _instance ?? (_instance = new DatabaseConnectOld());
            }
        }
